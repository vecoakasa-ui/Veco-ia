  ...
  return (
    <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
      ...
      <div style={{ display: "flex", gap: "var(--space-3)", borderBottom: "2px solid var(--gray-200)", paddingBottom: "var(--space-2)", overflowX: "auto", marginTop: "var(--space-2)" }}>
        <Link 
          href={`/locataire/${tenantId}`}
          style={{ padding: "8px 16px", borderRadius: "var(--radius-md)", fontWeight: 600, border: "none", cursor: "pointer", background: "var(--primary)", color: "var(--white)", transition: "all 0.2s", textDecoration: "none", whiteSpace: "nowrap" }}
        >
          Vue d'ensemble
        </Link>
        <Link 
        ...
        <Link 
          href={`/locataire/${tenantId}#logement`}
          style={{ padding: "8px 16px", borderRadius: "var(--radius-md)", fontWeight: 600, border: "none", cursor: "pointer", background: "transparent", color: "var(--gray-600)", transition: "all 0.2s", textDecoration: "none", whiteSpace: "nowrap" }}
        >
          Mon logement
        </Link>
        <Link 
          href={`/locataire/${tenantId}/paiements`}
          style={{ padding: "8px 16px", borderRadius: "var(--radius-md)", fontWeight: 600, border: "none", cursor: "pointer", background: "transparent", color: "var(--gray-600)", transition: "all 0.2s", textDecoration: "none", whiteSpace: "nowrap" }}
        >
          Paiements
        </Link>
        <Link 
          href={`/locataire/${tenantId}/incidents`}
          style={{ padding: "8px 16px", borderRadius: "var(--radius-md)", fontWeight: 600, border: "none", cursor: "pointer", background: "transparent", color: "var(--gray-600)", transition: "all 0.2s", textDecoration: "none", whiteSpace: "nowrap" }}
        >
          Signalements
        </Link>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-6)", marginTop: "var(--space-4)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
          {/* Mon Logement */}
          <section id="logement" className="card" style={{ padding: "var(--space-5)" }}>
